...
//Recipients
        ...
        $mail->AddEmbeddedImage('C:\xampp\htdocs\NTECH INVESTMENS LTD\assets\images\image-1.png',"image");
        ...
        * {
        ...
        table, td { color: #000000; } @media (max-width: 480px) { #u_column_2 .v-col-border { border-top: 5px solid #8d95ff !important;border-left: 5px solid #8d95ff !important;border-right: 5px solid #8d95ff !important;border-bottom: 5px solid #8d95ff !important; } #u_content_image_1 .v-container-padding-padding { padding: 20px 10px 10px !important; } #u_content_image_1 .v-src-width { width: auto !important; } #u_content_image_1 .v-src-max-width { max-width: 31% !important; } #u_content_text_2 .v-container-padding-padding { padding: 20px 10px 10px !important; } }
            </style>
        ...
        <!--[if (mso)|(IE)]><td align="center" width="570" class="v-col-border" style="background-color: #ffffff;width: 570px;padding: 0px;border-top: 15px solid #ecf0f1;border-left: 15px solid #ecf0f1;border-right: 15px solid #ecf0f1;border-bottom: 15px solid #ecf0f1;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
        <div id="u_column_2" class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
          ...
          <!--[if (!mso)&(!IE)]><!--><div class="v-col-border" style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 15px solid #ecf0f1;border-left: 15px solid #ecf0f1;border-right: 15px solid #ecf0f1;border-bottom: 15px solid #ecf0f1;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td style="padding-right: 0px;padding-left: 0px;" align="center">
              ...
              <img align="center" border="0" src="cid:logo" width="52.2" class="v-src-width v-src-max-width"/> NTECH INVESTMENT
        ...
        <table id="u_content_text_2" style="font-family:sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="font-family: times new roman,times; font-size: 19px; line-height: 180%; text-align: left; word-wrap: break-word;">
            <p style="line-height: 180%;"><span data-metadata="&lt;!--(figmeta)eyJmaWxlS2V5IjoiTHJJMHBSU20xM203UWc0Tk1XZXVQeCIsInBhc3RlSUQiOjE4NjYyMDI5OTgsImRhdGFUeXBlIjoic2NlbmUifQo=(/figmeta)--&gt;" style="line-height: 34.2px;"></span>Thank you for your prompt response to my inquiry. I appreciate your attention to my message and the information provided. [You can optionally add more specific gratitude or mention any assistance provided by the recipient.] Please feel free to reach out if you need any further clarification or assistance. I look forward to the opportunity to further engage with you.</p>
        <p style="line-height: 180%;">Best regards,</p>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td style="padding-right: 0px;padding-left: 0px;" align="center">
              ...
              <img align="center" border="0" src="cid:image" alt="image" title="image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 90%;max-width: 540px;" width="540" class="v-src-width v-src-max-width"> 
        ...
        <table style="font-family:sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="font-size: 19px; line-height: 140%; text-align: center; word-wrap: break-word;">
            <p style="line-height: 140%;"><strong>Need anything else?</strong></p>
